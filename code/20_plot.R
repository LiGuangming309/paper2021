...
for (location in attrBurden[, get(agr_by_new)] %>% unique()) {
  for (sourceX in attrBurden$source %>% unique()) {
    ...
    ggsave(file.path(plotDirX, paste0(location, "_plot1_race.png")), plot = g)
    ...
    ggsave(file.path(plotDirX, paste0(location, "_plot2_race.png")), plot = g)
    ...
    ggsave(file.path(plotDirX, paste0(location, "_plot3_race.png")), plot = g)

    g <- g + geom_ribbon(aes(ymin = lower, ymax = upper), linetype = 0, alpha = 0.1)
    ggsave(file.path(plotDirX, paste0(location, "_plot3_conf_race.png")), plot = g)
    ...
    ggsave(file.path(plotDirX, paste0(location, "_plot4_race.png")), plot = g)
    
    g <- g + geom_ribbon(aes(ymin = lower, ymax = upper), linetype = 0, alpha = 0.1)
    ggsave(file.path(plotDirX, paste0(location, "_plot4_conf_race.png")), plot = g)
    ...
    ggsave(file.path(plotDirX, paste0(location, "_plot5_race.png")), plot = g)
    g <- g + geom_ribbon(aes(ymin = lower, ymax = upper), linetype = 0, alpha = 0.1)
    ggsave(file.path(plotDirX, paste0(location, "_plot5_conf_race.png")), plot = g)
  }
}
...
for (location in attrBurden[, get(agr_by_new)] %>% unique()) {
    ...
    ggsave(file.path(plotDirX, paste0(location, "_plot1_educ.png")), plot = g)
    ...
    ggsave(file.path(plotDirX, paste0(location, "_plot2_educ.png")), plot = g)
    ...
    ggsave(file.path(plotDirX, paste0(location, "_plot3_educ.png")), plot = g)
    
    g <- g + geom_ribbon(aes(ymin = lower, ymax = upper), linetype = 0, alpha = 0.1)
    ggsave(file.path(plotDirX, paste0(location, "_plot3_conf_educ.png")), plot = g)
    ...
    ggsave(file.path(plotDirX, paste0(location, "_plot4_educ.png")), plot = g)
    
    g <- g + geom_ribbon(aes(ymin = lower, ymax = upper), linetype = 0, alpha = 0.1)
    ggsave(file.path(plotDirX, paste0(location, "_plot4_conf_educ.png")), plot = g)
    ...
    ggsave(file.path(plotDirX, paste0(location, "_plot5_educ.png")), plot = g)
    g <- g + geom_ribbon(aes(ymin = lower, ymax = upper), linetype = 0, alpha = 0.1)
    ggsave(file.path(plotDirX, paste0(location, "_plot5_conf_educ.png")), plot = g)
