  ...
  findreplaces3 <-
    rbind(
      ...
      data.frame(
        ...
        from = c(sprintf("1%03d",1:135),sprintf("2%03d",c(0:11,999)),sprintf("4%03d",c(0:27,999)),sprintf("5%03d",c(0:23,999)),sprintf("6%03d",c(0:59,999)),"9999"),
        to = c(sprintf("%03d",1:135),rep("0", 13+29+25+61),"Unknown")
      ),
      data.frame(
