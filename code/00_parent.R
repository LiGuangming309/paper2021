...
read.total.burden.script <- file.path(code.dir, "13_read_tot.R")
read.nvs.findrepl.script <- file.path(code.dir, "14_nvss_findrepl.R")
read.total.burden.nvs.script <- file.path(code.dir, "15_read_tot_nvss.R")
pop.summary.script <- file.path(code.dir, "16_popsum.R")
pop.summary.educ.script <- file.path(code.dir, "17_popsum_educ.R")
add.rate.tot.burd <- file.path(code.dir, "18_add_rate_totburd.R")
calc.attr.burd.script <- file.path(code.dir, "19_calc_attr_burd.R")
calc.attr.burd.alt.script <- file.path(code.dir, "20_calc_attr_burd_alt.R")
