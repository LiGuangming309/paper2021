...
packages <- c("dplyr", "magrittr", "data.table", "testthat", "tidyverse", "tictoc", "readr")
...
totalBurdenDir <- "~/Google Drive/currentDocumants/mixed Data/2020/2020job/HIGH/Progress/R code/Transfer/raw_restricted_fake"
# Where the parsed files should be stored
totalBurdenParsedDir <- "~/Google Drive/currentDocumants/mixed Data/2020/2020job/HIGH/Progress/R code/Transfer"
